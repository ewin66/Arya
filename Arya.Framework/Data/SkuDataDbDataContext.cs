    ...
    public partial class SkuDataDbDataContext
    {
        ...
        public static void DefaultTableValues(object o)
        {
            ...
            if (!PropertyCache.ContainsKey(currentType))
            {
                ...
                if (createdBy != null)
                    actions.Add(p => (currentType.DelegateForSetPropertyValue("CreatedBy"))(p, NatalieTools.Instance.CurrentUser.ID));
                ...
                if (remark != null)
                    actions.Add(p => (currentType.DelegateForSetPropertyValue("CreatedRemark"))(p, NatalieTools.Instance.RemarkID));
