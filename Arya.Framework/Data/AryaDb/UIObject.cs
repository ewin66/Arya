...
{
    partial class UIObject : BaseEntity, IComparable
    {
        ...
        public UIObject(AryaDbDataContext parentContext, bool initialize = true) : this()
        {
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!thisString.Equals(objString))
                return String.Compare(thisString, objString, StringComparison.Ordinal);
        ...
        public static Guid GetIdentifier(UIAction uiAction)
        {
            ...
            switch (uiAction)
            {
                case UIAction.AryaReadOnly:
                    retGuid = AryaReadOnly;
                    break;
                case UIAction.AttributeView:
                    retGuid = AttributeView;
                    break;
        ...
        public static string[] GetUIObjectNames() { return Enum.GetNames(typeof (UIAction)); }
