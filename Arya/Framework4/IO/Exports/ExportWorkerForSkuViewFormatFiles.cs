...
{
    [Serializable]
    public class ExportWorkerForSkuViewFormatFiles : ExportWorker
    {
        ...
        public ExportWorkerForSkuViewFormatFiles(string argumentDirectoryPath, PropertyGrid ownerPropertyGrid)
        ...
        public ExportWorkerForSkuViewFormatFiles(string argumentDirectoryPath, SerializationInfo info, StreamingContext ctxt)
