...
namespace Arya.HelperClasses
{
    ...
    public static class BaseUnitConversion
    {
        ...
        {
            get { return _uoms ?? (_uoms = AryaTools.Instance.InstanceData.Dc.UnitOfMeasures.ToList()); }
        }
        ...
        public static List<ProjectUom> ProjectUoms
        {
            get
            {
                return _projectUoms ??
                       (_projectUoms =
                        AryaTools.Instance.InstanceData.Dc.ProjectUoms.Where(
                            p => p.ProjectID == AryaTools.Instance.InstanceData.CurrentProject.ID).ToList());
            }
        }
