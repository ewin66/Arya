...
namespace Arya.Framework.Extensions
{
    ...
    public class ControlFactory
    {
            ...
            try
            {
                ...
                switch (ctrlName)
                {
                    ...
                    case "DateTimePicker":
                        ...
                        break;
                    default:
                        Assembly controlAsm = Assembly.Load(partialName);
        ...
        public static Control CloneCtrl(Control ctrl)
        {
            ...
            var cbCtrl = new CBFormCtrl(ctrl);
            var newCtrl = CreateControl(cbCtrl.CtrlName, cbCtrl.PartialName);
        ...
        public static Control GetCtrlFromClipBoard()
        {
            ...
            {
                var cbCtrl = ido.GetData(CBFormCtrl.Format.Name) as CBFormCtrl;
